...
const App: React.FC = () => {
  ...
  const [appState, setAppState] = useState<AppState>({
    ...
    selectionBox: null,
    content: {
      productName: "Premium Collection", // Meta info
      showProductName: true,
      productNameColor: "#86868b", // Apple Gray
      headline: "Ultra Pro.", 
      showHeadline: true,
      headlineColor: "#1d1d1f", // Apple Black
      subheadline: "Tytanowa konstrukcja. Niesamowita moc.", 
      showSubheadline: true,
      subheadlineColor: "#1d1d1f",
      ctaText: "Kup teraz", 
      showCTA: true,
      ctaBgColor: "#0071e3", // Apple Blue
      ctaTextColor: "#ffffff",
      ctaStyle: 'solid',
      ctaAnimation: 'none',
      ctaAnimationEnabled: true,
      contactInfo: "apple.com/pl",
      showContact: false,
      contactInfoColor: "#86868b",
      promoBadge: "Nowość",
      showPromoBadge: false,
      promoBadgeBgColor: "#1d1d1f",
    ...
    colors: {
        ...
        secondary: "#86868b",
        accent: "#0071e3",
        background: "#ffffff", // Changed default to pure white per request
        text: "#1d1d1f"
    },
    typography: {
        headlineFont: 'Inter',
    ...
    textLayout: {
        // Initial Layout: Centered Stack (Apple style)
        productName: { // Meta (Top small)
            square: { scale: 0.8, x: 0, y: -250, rotation: 0, zIndex: 48, textAlign: 'center', lineHeight: 1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            portrait: { scale: 0.8, x: 0, y: -400, rotation: 0, zIndex: 48, textAlign: 'center', lineHeight: 1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            landscape: { scale: 0.8, x: 0, y: -200, rotation: 0, zIndex: 48, textAlign: 'center', lineHeight: 1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
        },
        headline: { // Big Title
            square: { scale: 1.2, x: 0, y: -150, rotation: 0, zIndex: 50, textAlign: 'center', lineHeight: 0.95, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            portrait: { scale: 1.5, x: 0, y: -250, rotation: 0, zIndex: 50, textAlign: 'center', lineHeight: 0.95, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            landscape: { scale: 1.2, x: 0, y: -100, rotation: 0, zIndex: 50, textAlign: 'center', lineHeight: 0.95, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
        },
        subheadline: { // Subtitle under title
            square: { scale: 0.9, x: 0, y: -50, rotation: 0, zIndex: 49, textAlign: 'center', lineHeight: 1.4, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            portrait: { scale: 1, x: 0, y: -50, rotation: 0, zIndex: 49, textAlign: 'center', lineHeight: 1.4, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            landscape: { scale: 0.9, x: 0, y: 20, rotation: 0, zIndex: 49, textAlign: 'center', lineHeight: 1.4, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
        },
        cta: { // Button
            square: { scale: 1, x: 0, y: 350, rotation: 0, zIndex: 47, textAlign: 'center', lineHeight: 1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            portrait: { scale: 1, x: 0, y: 600, rotation: 0, zIndex: 47, textAlign: 'center', lineHeight: 1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            landscape: { scale: 1, x: 0, y: 300, rotation: 0, zIndex: 47, textAlign: 'center', lineHeight: 1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
        },
        contact: defaultTextTransform(20),
        badge: { // Badge defaults to 46
            square: { scale: 1, x: 0, y: 0, rotation: 0, zIndex: 46, textAlign: 'center', lineHeight: 1.1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            portrait: { scale: 1, x: 0, y: 0, rotation: 0, zIndex: 46, textAlign: 'center', lineHeight: 1.1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
            landscape: { scale: 1, x: 0, y: 0, rotation: 0, zIndex: 46, textAlign: 'center', lineHeight: 1.1, locked: false, shadow: { enabled: false, color: '#000000', blur: 10, x: 5, y: 5 } },
        }
    }
  });
