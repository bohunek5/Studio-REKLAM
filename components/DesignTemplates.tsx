    ...
    <BaseContainer format={format} bg={colors.primary} state={state}>
      {images.backgroundImage && (
        <div className="absolute inset-0 z-0">
           <img src={images.backgroundImage} className="w-full h-full object-cover opacity-60" alt="bg" />
           <div className="absolute inset-0" style={{background: `linear-gradient(to top, ${colors.primary} 10%, transparent 60%)`}}></div>
        </div>
      )}
